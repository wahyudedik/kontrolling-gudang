                ...
                <div class="bg-white shadow-sm rounded-lg p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required class="w-full rounded-md border-gray-300">
                            ...
                            <option value="man_power" {{ old('type') == 'man_power' ? 'selected' : '' }}>Man Power
                            </option>
                            <option value="finish_good" {{ old('type') == 'finish_good' ? 'selected' : '' }}>Finish Good
                            </option>
                            <option value="raw_material" {{ old('type') == 'raw_material' ? 'selected' : '' }}>Raw
                                Material</option>
                            <option value="gudang" {{ old('type') == 'gudang' ? 'selected' : '' }}>Gudang</option>
                            <option value="supplier_datang" {{ old('type') == 'supplier_datang' ? 'selected' : '' }}>
                                Supplier Datang</option>
                            <option value="daily" {{ old('type') == 'daily' ? 'selected' : '' }}>Habit Harian</option>
                        </select>
                        @error('type')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="difficulty_level" class="w-full rounded-md border-gray-300">
                            ...
                            <option value="medium"
                                {{ old('difficulty_level', 'medium') == 'medium' ? 'selected' : '' }}>Medium</option>
