<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user()->isSupervisor())
                        <x-nav-link :href="route('supervisor.todos')" :active="request()->routeIs('supervisor.*')">
                            {{ __('To Dos') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isSuperAdmin())
                <x-responsive-nav-link :href="route('todo-lists.index')" :active="request()->routeIs('todo-lists.*')">
                    {{ __('To Do Lists') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->isSupervisor())
                <x-responsive-nav-link :href="route('supervisor.todos')" :active="request()->routeIs('supervisor.*')">
                    {{ __('To Dos') }}
                </x-responsive-nav-link>
